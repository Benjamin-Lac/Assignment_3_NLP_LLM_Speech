...
print()
print("MLP Architecture (both approaches):")
print("  Input layer   : depends on feature dimension")
print("  Hidden layer 1: 256 neurons, ReLU activation")
print("  Hidden layer 2: 128 neurons, ReLU activation")
print("  Output layer  : 2 classes (ham / spam), softmax")
print("  Optimizer     : Adam (learning_rate=0.001)")
print("  Regularization: early stopping, validation_fraction=0.1")
print()
winner = "Row" if acc_row >= acc_col else "Column"
print(f"  {winner} vectors perform better.")
print()
print("Discussion:")
print("  Row vectors (documents) directly encode each email's full")
print("  content as a term-frequency vector. The MLP learns precise")
print("  document-level patterns (e.g., combinations of spam words).")
print()
print("  Column vectors (terms) require an indirect two-step process:")
print("  (1) classify each term as spam/ham using its doc-frequency")
print("  profile, then (2) aggregate term predictions to score a doc.")
print("  The proxy term labels introduce noise, so document-level")
print("  accuracy is generally lower than the direct row approach.")
print("  Both vectors are built from the same DTM but the column")
print("  approach loses document-level label information during the")
print("  term-label derivation step.")
